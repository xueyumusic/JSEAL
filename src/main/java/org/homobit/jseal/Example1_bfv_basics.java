...
public class Example1_bfv_basics {
    ...
    public static void main(String[] args) {
        ...
        */
        System.out.println("Set encryption parameters and print");
        ...
        */
        int x = 6;
        Plaintext x_plain = new Plaintext(Integer.toString(x));
        System.out.println("Express x = " + Integer.toString(x) +
            " as a plaintext polynomial 0x" + x_plain.toString() + ".");
        /*
        We then encrypt the plaintext, producing a ciphertext.
        */
        Ciphertext x_encrypted = new Ciphertext();
        System.out.println("Encrypt x_plain to x_encrypted.");
        ...
        has size 2.
        */
        System.out.println("    + size of freshly encrypted x: " + x_encrypted.size());
        System.out.println("    + noise budget in freshly encrypted x: " + decryptor.invariant_noise_budget(x_encrypted) + " bits");
        /*
        We decrypt the ciphertext and print the resulting plaintext in order to
        demonstrate correctness of the encryption.
        */
        Plaintext x_decrypted = new Plaintext();
        System.out.println("    + decryption of x_encrypted: ");
        decryptor.decrypt(x_encrypted, x_decrypted);
        System.out.println("0x" + x_decrypted.toString() + " ...... Correct.");
        /*
        ...
        */
        ...
        Ciphertext x_sq_plus_one = new Ciphertext();
        evaluator.square(x_encrypted, x_sq_plus_one);
        Plaintext plain_one = new Plaintext("1");
        ...
        consumption.
        */
        System.out.println("    + size of x_sq_plus_one: " + x_sq_plus_one.size());
        System.out.println("    + noise budget in x_sq_plus_one: " + decryptor.invariant_noise_budget(x_sq_plus_one) + " bits");
        /*
        ...
        */
        ...
        System.out.println("    + decryption of x_sq_plus_one: ");
        decryptor.decrypt(x_sq_plus_one, decrypted_result);
        System.out.println("0x" + decrypted_result.toString() + " ...... Correct.");
        /*
        Next, we compute (x + 1)^2.
        */
        System.out.println("Compute x_plus_one_sq ((x+1)^2).");
        Ciphertext x_plus_one_sq = new Ciphertext();
        evaluator.add_plain(x_encrypted, plain_one, x_plus_one_sq);
        evaluator.square_inplace(x_plus_one_sq);
        System.out.println("    + size of x_plus_one_sq: " + x_plus_one_sq.size());
        System.out.println("    + noise budget in x_plus_one_sq: " + decryptor.invariant_noise_budget(x_plus_one_sq) + " bits");
        System.out.println("    + decryption of x_plus_one_sq: ");
        ...
        */
        ...
        Plaintext plain_four = new Plaintext("4");
        evaluator.multiply_plain_inplace(x_sq_plus_one, plain_four);
        evaluator.multiply(x_sq_plus_one, x_plus_one_sq, encrypted_result);
        System.out.println("    + size of encrypted_result: " + encrypted_result.size());
        System.out.println("    + noise budget in encrypted_result: " + decryptor.invariant_noise_budget(encrypted_result) + " bits");
        System.out.println("NOTE: Decryption can be incorrect if noise budget is zero.");
        System.out.println("~~~~~~ A better way to calculate 4(x^2+1)(x+1)^2. ~~~~~~");
        ...
        */
        System.out.println("Generate relinearization keys.");
        RelinKeys relinKeys = keyGenerator.getRelinKeys();
        /*
        We now repeat the computation relinearizing after each multiplication.
        */
        System.out.println("Compute and relinearize x_squared (x^2),");
        System.out.println("then compute x_sq_plus_one (x^2+1)");
        Ciphertext x_squared = new Ciphertext();
        evaluator.square(x_encrypted, x_squared);
        System.out.println("    + size of x_squared: " + x_squared.size());
        evaluator.relinearize_inplace(x_squared, relinKeys);
        System.out.println("    + size of x_squared (after relinearization): " + x_squared.size());
        ...
        Ciphertext x_plus_one = new Ciphertext();
        System.out.println("then compute and relinearize x_plus_one_sq ((x+1)^2).");
        ...
        System.out.println("Compute and relinearize encrypted_result (4(x^2+1)(x+1)^2).");
        evaluator.multiply_plain_inplace(x_sq_plus_one, plain_four);
        evaluator.multiply(x_sq_plus_one, x_plus_one_sq, encrypted_result);
        System.out.println("    + size of encrypted_result: " + encrypted_result.size());
        evaluator.relinearize_inplace(encrypted_result, relinKeys);
        System.out.println("    + size of encrypted_result (after relinearization): " + encrypted_result.size());
        System.out.println("    + noise budget in encrypted_result: " + decryptor.invariant_noise_budget(encrypted_result) + " bits");
        System.out.println("NOTE: Notice the increase in remaining noise budget.");
        ...
        */
        System.out.println("Decrypt encrypted_result (4(x^2+1)(x+1)^2).");
        decryptor.decrypt(encrypted_result, decrypted_result);
        System.out.println("    + decryption of 4(x^2+1)(x+1)^2 = 0x" + decrypted_result.toString() + " ...... Correct.");
